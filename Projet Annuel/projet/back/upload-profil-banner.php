...
$target_dir = "./upload-profil-banner/";
...
// Check if image file is a actual image or fake image  default_banner
...
if(!isset($_POST["submit"])) {
    ...
    if ($uploadOk == 0) {
        echo "Sorry, your file was not uploaded.";
            ...
            $query = $bdd_connexion->prepare("UPDATE USER SET image_banner = :image WHERE email = :email");
            $query -> execute([
                ":email" => $_SESSION["username"],
                ":image" => $image_name
            ]);
